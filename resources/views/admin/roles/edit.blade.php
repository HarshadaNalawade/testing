        ...
        <div class="row">
            <div class="col-md-11">
                <div class="panel panel-default">
                    <div class="panel-heading">Edit Role #{{ $role->role_id }}</div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/roles/' . $role->role_id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
